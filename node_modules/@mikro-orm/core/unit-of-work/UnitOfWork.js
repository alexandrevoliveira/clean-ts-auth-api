...
class UnitOfWork {
    ...
    merge(entity, visited) {
        ...
        (_a = wrapped.__em) !== null && _a !== void 0 ? _a : (wrapped.__em = this.em);
        ...
        this.cascade(entity, enums_1.Cascade.MERGE, visited !== null && visited !== void 0 ? visited : new Set());
    }
    /**
     * @internal
     */
    registerManaged(entity, data, refresh, newEntity) {
        ...
        (_a = (_b = helper).__em) !== null && _a !== void 0 ? _a : (_b.__em = this.em);
    ...
    persist(entity, visited, options = {}) {
        ...
        if ((_a = options.cascade) !== null && _a !== void 0 ? _a : true) {
    ...
    computeChangeSets() {
        ...
        for (const entity of this.removeStack) {
            this.changeSets.set(entity, new ChangeSet_1.ChangeSet(entity, ChangeSet_1.ChangeSetType.DELETE, {}, entity.__meta));
        }
    }
