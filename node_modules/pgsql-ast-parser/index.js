...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "word", "symbols": [(lexer_1.lexerAny.has("quoted_word") ? { type: "quoted_word" } : quoted_word)], "postprocess": x => lexer_2.box(x, x[0].value, true) },
        { "name": "word", "symbols": [(lexer_1.lexerAny.has("word") ? { type: "word" } : word)], "postprocess": x => lexer_2.box(x, x[0].value) },
        ...
        { "name": "qualified_name_mark_quotes", "symbols": ["qname_ident"], "postprocess": x => lexer_2.track(x, { name: toStr(x), ...lexer_2.doubleQuoted(x) }) },
        { "name": "qualified_name_mark_quotes", "symbols": ["ident", "dot", "ident_extended"], "postprocess": x => {
                const schema = toStr(x[0]);
                const name = toStr(x[2]);
                return lexer_2.track(x, { schema, name, ...lexer_2.doubleQuoted(x[2]) });
            } },
        { "name": "qualified_name_mark_quotes", "symbols": [(lexer_1.lexerAny.has("kw_current_schema") ? { type: "kw_current_schema" } : kw_current_schema)], "postprocess": x => lexer_2.track(x, { name: 'current_schema' }) },
        ...
        { "name": "select_table_join", "symbols": ["select_join_op", (lexer_1.lexerAny.has("kw_join") ? { type: "kw_join" } : kw_join), "select_from_subject", "select_table_join$ebnf$1"], "postprocess": x => lexer_2.track(x, {
                ...unwrap(x[2]),
                join: {
                    type: toStr(x[0], ' '),
                    ...x[3] && unwrap(x[3]),
        ...
        { "name": "select_join_op$subexpression$2", "symbols": [(lexer_1.lexerAny.has("kw_cross") ? { type: "kw_cross" } : kw_cross)], "postprocess": x => lexer_2.box(x, 'CROSS JOIN') },
        ...
        { "name": "select_join_op$subexpression$3", "symbols": [(lexer_1.lexerAny.has("kw_left") ? { type: "kw_left" } : kw_left), "select_join_op$subexpression$3$ebnf$1"], "postprocess": x => lexer_2.box(x, 'LEFT JOIN') },
        ...
        { "name": "select_join_op$subexpression$4", "symbols": [(lexer_1.lexerAny.has("kw_right") ? { type: "kw_right" } : kw_right), "select_join_op$subexpression$4$ebnf$1"], "postprocess": x => lexer_2.box(x, 'RIGHT JOIN') },
        ...
        { "name": "select_join_op$subexpression$5", "symbols": [(lexer_1.lexerAny.has("kw_full") ? { type: "kw_full" } : kw_full), "select_join_op$subexpression$5$ebnf$1"], "postprocess": x => lexer_2.box(x, 'FULL JOIN') },
        ...
        { "name": "expr_function_call", "symbols": ["expr_fn_name", "lparen", "expr_function_call$ebnf$1", "rparen"], "postprocess": x => lexer_2.track(x, {
                type: 'call',
                function: unwrap(x[0]),
                args: x[2] || [],
            }) },
        ...
        { "name": "expr_fn_name$subexpression$2", "symbols": ["expr_fn_name$subexpression$2$subexpression$1"], "postprocess": x => lexer_2.track(x, {
                name: toStr(unwrap(x)),
            }) },
        ...
        { "name": "createtable_column_constraint_def", "symbols": ["createtable_references"], "postprocess": x => lexer_2.track(x, { type: 'reference', ...unwrap(x) }) },
        ...
        { "name": "simplestatements_set_val_raw", "symbols": [(lexer_1.lexerAny.has("quoted_word") ? { type: "quoted_word" } : quoted_word)], "postprocess": x => lexer_2.track(x, { type: 'identifier', doubleQuoted: true, name: unwrap(x).value }) },
        ...
        { "name": "delete_truncate", "symbols": ["delete_truncate$subexpression$1", "delete_truncate$macrocall$1", "delete_truncate$ebnf$1", "delete_truncate$ebnf$2"], "postprocess": x => lexer_2.track(x, {
                type: 'truncate table',
                tables: x[1],
        ...
        { "name": "drop_what", "symbols": ["kw_type"], "postprocess": x => lexer_2.track(x, { type: 'drop type' }) },
        ...
        { "name": "deallocate", "symbols": ["kw_deallocate", "deallocate$ebnf$1", "deallocate_target"], "postprocess": x => lexer_2.track(x, {
                type: 'deallocate',
                target: x[2],
            }) },
        ...
        { "name": "deallocate_name", "symbols": ["ident"], "postprocess": x => lexer_2.track(x, asName(x[0])) },
        { "name": "deallocate_all", "symbols": [(lexer_1.lexerAny.has("kw_all") ? { type: "kw_all" } : kw_all)], "postprocess": x => lexer_2.track(x, { option: 'all' }) },
        ...
        { "name": "refresh_view_statements", "symbols": ["kw_refresh", "kw_materialized", "kw_view", "refresh_view_statements$ebnf$1", "qname", "refresh_view_statements$ebnf$2"], "postprocess": x => lexer_2.track(x, {
